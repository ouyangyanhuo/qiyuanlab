        ...
        <!--分导航内容S-->
            ...
            <li class="bold active">
                ...
                <div class="collapsible-body">
                    ...
                    <li class="active">
                        <a class="collapsible-body active" href="./Todayhistory.php">
    ...
    <div id="main">
      <div class="row">
            ...
            <div class="container">
              <div class="row">
                <div class="col s10 m6 l6">
                  <h5 class="breadcrumbs-title mt-0 mb-0">历史上的今天 (Todayhistory)</h5>
                  <ol class="breadcrumbs mb-0 truncate">
                    <li class="breadcrumb-item"><a href="/">首页</a></li>
                    <li class="breadcrumb-item active">历史上的今天 (Todayhistory)</li>
                  </ol>
                </div>
                <div class="col s2 m6 l6">
                  <a class="btn waves-effect waves-light breadcrumbs-btn right" href="./Todayhistory">
                ...
                <div class="col s12 m12 l12">
                  <div class="card card-default animated zoomIn">
                    <div class="card-content faq">
                      ...
                      <p><a href="./News/download/develop1.0.zip" target="_blank">develop1.0.zip</a></p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="mdui-dialog" id="data-1">
            ...
            <div class="mdui-dialog-content">创建历史上的今天实验</div>
