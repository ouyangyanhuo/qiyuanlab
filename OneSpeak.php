        ...
        <!--分导航内容S-->
            ...
            <li class="bold active">
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                    <li class="active">
                        <a class="collapsible-body active" href="./OneSpeak.php">
            ...
            <div class="container">
              <div class="row">
                <div class="col s10 m6 l6">
                  <h5 class="breadcrumbs-title mt-0 mb-0">一言 (OneSpeak)</h5>
                  <ol class="breadcrumbs mb-0 truncate">
                    <li class="breadcrumb-item"><a href="/">首页</a></li>
                    <li class="breadcrumb-item active">一言 (OneSpeak)</li>
                  </ol>
                </div>
                <div class="col s2 m6 l6">
                  <a class="btn waves-effect waves-light breadcrumbs-btn right" href="./OneSpeak">
                ...
                <div class="col s12 m12 l12">
                  <div class="card card-default animated zoomIn">
                    <div class="card-content faq">
                      ...
                      <p><a style="color:orange">直接引用</a></p>
                      <p>拷贝下代码进入你想要的地方即可</p>
                      <p><div class="mdui-typo"><pre><div class="dp-highlighter"><div class="bar"></div><ol start="" class="dp-j"><li class="alt"><span><span>&lt;script&nbsp;src=</span><span class="string">"https://www.kpan.me/OneSpeak/api.php"</span><span>&gt;&lt;/script&gt;&nbsp;&nbsp;</span></span></li></ol></div></pre></p></div></p>
                      <p><a style="color:orange">开源下载</a></p>
                      <p>仅提供最新版本下载，历史版本请查看更新版本</p>
                      <p><a href="./OneSpeak/download/develop1.0.zip" target="_blank">develop1.0.zip</a></p>
                    <div>
                  </div>
                </div>
              </div>
